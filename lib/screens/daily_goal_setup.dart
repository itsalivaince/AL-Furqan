...
class _DailyGoalSetupScreenState extends State<DailyGoalSetupScreen> {
  ...
  void initState() {
    super.initState();
    _pagesPerDay = widget.initialPages;
    _reminderTime = widget.initialReminder;
  }
  ...
  Widget build(BuildContext context) {
    // Total pages in standard Quran is 604
    final int daysToComplete = (_pagesPerDay > 0) ? (604 / _pagesPerDay).ceil() : 604;
    final int minutesPerDay = _pagesPerDay * 3; // Est. 3 minutes per page
                          ...
                          _buildCardSection(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                GoalProgressChart(currentGoal: _pagesPerDay),
                              ],
                            ),
                          ),
                          const SizedBox(height: 24),

                          // --- 2. DYNAMIC FORECAST MODULE ---
                          _buildCardSection(
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: () async {
                          // Directly write settings to the reactive ProgressController
                          final progressController = Get.find<ProgressController>();
                          await progressController.updateDailyGoal(_pagesPerDay);
                          await progressController.updateReminderTime(_reminderTime);
